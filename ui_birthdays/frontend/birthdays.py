...
from ui_birthdays.backend.birth_backend import birth_info_output, holidays_info_output
...
class Birthdays(QWidget):
    ...
    def birth_widget_window(self):
        ...
        self.birth_widget.setStyleSheet(open("css-styles/main_widgets/birth_widget.css").read())
